...
export const getCalculatorDailyRate = state =>
  state.user.calculator.calculatorDailyRate;
export const getDiaryIsLoading = state => state.user.diary.diaryIsLoading;
export const getCalculatorIsLoading = state =>
  state.user.calculator.calculatorIsLoading;
export const getDiaryError = state => state.user.diary.diaryError;
export const getCalculatorError = state =>
  state.user.calculator.calculatorError;
...
export const getNotAllowedFoodsList = state => state.user.badFoodSearcList;
